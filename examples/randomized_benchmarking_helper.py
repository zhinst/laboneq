...
def basic_gate_set(pi_amp, pi_2_amp, gate_time, sigma, sample_rate):
    ...
    gate_set = {
        ...
        'Y': pulse_envelope(pi_amp, gate_time, 90, sigma=sigma, sample_rate=sample_rate),
        'X/2': pulse_envelope(pi_2_amp, gate_time, 0, sigma=sigma, sample_rate=sample_rate),
        'Y/2': pulse_envelope(pi_2_amp, gate_time, 90, sigma=sigma, sample_rate=sample_rate),
        '-X/2': pulse_envelope(-pi_2_amp, gate_time, 0, sigma=sigma, sample_rate=sample_rate),
        '-Y/2': pulse_envelope(-pi_2_amp, gate_time, 90, sigma=sigma, sample_rate=sample_rate),
        }
    return gate_set
...
clifford_matrices = [[elem_gates[gate] for gate in gates] for gates in clifford_parametrized]
