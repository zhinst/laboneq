...
use crate::py_device::py_device_to_device;
...
use crate::setup_processor::process_signals;
...
fn build_experiment_py(
    ...
    let signal_processing_result = process_signals(
        setup_properties.signals,
        &setup_properties.devices,
        desktop_setup,
    )
    .map_err(|e| {
        let msg = create_error_message(e);
    ...
    Ok(ExperimentPy {
        ...
        context,
        delay_compensation: signal_processing_result.on_device_delays,
    })
}
