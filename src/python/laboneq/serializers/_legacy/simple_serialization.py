...
from laboneq.serializers._legacy.externals import (
...
@deprecated(
    "The laboneq.core.serialization is deprecated. Use `laboneq.serializers.to_dict` instead.",
...
@deprecated(
    "The laboneq.core.serialization is deprecated. Use `laboneq.serializers.from_dict` instead.",
    category=FutureWarning,
)
